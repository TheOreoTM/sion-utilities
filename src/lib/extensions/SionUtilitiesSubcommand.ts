...
export abstract class SionUtilities<M extends Module> extends ModuleSubcommand<M> {
	public helpEmbed: EmbedBuilder;

	public constructor(context: SionUtilities.Context, options: SionUtilities.Options) {
...
export namespace SionUtilities {
