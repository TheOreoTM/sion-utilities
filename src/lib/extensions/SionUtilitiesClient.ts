import { SionUtilitiesLogger } from '#lib/extensions/SionUtilitiesLogger';
import { Enumerable } from '@sapphire/decorators';
import { LogLevel, SapphireClient, container } from '@sapphire/framework';
import { ActivityType, IntentsBitField, WebhookClient } from 'discord.js';

export class SionUtilitiesClient extends SapphireClient {
	@Enumerable(false)
	...
	public constructor() {
		...
		super({
			...
			logger: {
				instance: new SionUtilitiesLogger({
					level: LogLevel.Info,
					join: '\n'
				})
			},
