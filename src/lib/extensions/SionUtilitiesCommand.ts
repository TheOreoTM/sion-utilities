...
export abstract class SionUtilitiesCommand<M extends Module> extends ModuleCommand<M> {
	public helpEmbed: EmbedBuilder;

	public constructor(context: SionUtilitiesCommand.Context, options: SionUtilitiesCommand.Options) {
...
export namespace SionUtilitiesCommand {
